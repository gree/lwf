  ...
  Game = (function() {
    ...
    function Game(touchDelegate, stage, cache, textNode, graphNode) {
      ...
      this.onrelease = function(e) {
        return Game.prototype.onrelease.apply(_this, arguments);
      };
      this.onpress = function(e) {
        return Game.prototype.onpress.apply(_this, arguments);
      };
      this.onmove = function(e) {
        return Game.prototype.onmove.apply(_this, arguments);
      };
      this.requests = [];
