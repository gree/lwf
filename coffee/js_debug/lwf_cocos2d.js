...
(function() { var __FILE__ = 'lwf_cocos2d.js';
  var Align, AlphaTransform, Animation, Bitmap, BitmapEx, Button, ButtonEventHandlers, ClipEvent, Cocos2dBitmapContext, Cocos2dBitmapRenderer, Cocos2dParticleContext, Cocos2dParticleRenderer, Cocos2dRendererFactory, Cocos2dResourceCache, Cocos2dTextContext, Cocos2dTextRenderer, Color, ColorTransform, Condition, Constant, Data, Format, Graphic, IObject, LObject, LWF, LWFContainer, LWFLoader, LWFLoaderWithArrayBuffer, Loader, Matrix, Movie, MovieEventHandlers, NullRendererFactory, Particle, Point, ProgramObject, Property, Text, Translate, Type, Utility, WebkitCSSDomElementRenderer, WebkitCSSResourceCache, _ref,
  ...
  Button = (function(_super) {
    ...
    function Button(lwf, parent, objId, instId) {
      ...
      if (((_ref = this.handler) != null ? _ref.load : void 0) != null) {
    ...
    Button.prototype.exec = function(matrixId, colorTransformId) {
      ...
      if (((_ref = this.handler) != null ? _ref.enterFrame : void 0) != null) {
        this.handler.enterFrame(this);
      }
    };
    ...
    Button.prototype.update = function(m, c) {
      ...
      if (((_ref = this.handler) != null ? _ref.update : void 0) != null) {
    ...
    Button.prototype.render = function(v, rOffset) {
      var _ref;
      if (v && (((_ref = this.handler) != null ? _ref.render : void 0) != null)) {
    ...
    Button.prototype.destroy = function() {
      ...
      if (((_ref = this.handler) != null ? _ref.unload : void 0) != null) {
    ...
    Button.prototype.rollOver = function() {
      var _ref;
      if (((_ref = this.handler) != null ? _ref.rollOver : void 0) != null) {
        if (!this.handler.rollOver(this)) {
          return;
        }
      }
    ...
    Button.prototype.rollOut = function() {
      var _ref;
      if (((_ref = this.handler) != null ? _ref.rollOut : void 0) != null) {
        if (!this.handler.rollOut(this)) {
          return;
        }
      }
    ...
    Button.prototype.press = function() {
      var _ref;
      if (((_ref = this.handler) != null ? _ref.press : void 0) != null) {
        if (!this.handler.press(this)) {
          return;
        }
      }
    ...
    Button.prototype.release = function() {
      var _ref;
      if (((_ref = this.handler) != null ? _ref.release : void 0) != null) {
        if (!this.handler.release(this)) {
          return;
        }
      }
    ...
    Button.prototype.keyPress = function() {
      var _ref;
      if (((_ref = this.handler) != null ? _ref.keyPress : void 0) != null) {
        if (!this.handler.keyPress(this)) {
          return;
        }
      }
  ...
  Movie = (function(_super) {
    ...
    function Movie(lwf, parent, objId, instId, matrixId, colorTransformId, attached, handler) {
      ...
      if (((_ref1 = this.handler) != null ? _ref1.load : void 0) != null) {
        this.handler.load.call(this);
      }
    ...
    Movie.prototype.postExec = function(progressing) {
      ...
      while (true) {
        ...
        if (!this.postLoaded) {
          ...
          if (((_ref5 = this.handler) != null ? _ref5.postLoad : void 0) != null) {
            this.handler.postLoad.call(this);
          }
        }
        if (controlAnimationOffset !== -1 && this.execedFrame === this.currentFrameInternal) {
          ...
          if (!animationPlayed) {
            for (i = _m = controlAnimationOffset, _ref6 = frame.controls; controlAnimationOffset <= _ref6 ? _m < _ref6 : _m > _ref6; i = controlAnimationOffset <= _ref6 ? ++_m : --_m) {
              control = data.controls[frame.controlOffset + i];
      ...
      if (((_ref7 = this.handler) != null ? _ref7.enterFrame : void 0) != null) {
        this.handler.enterFrame.call(this);
      }
    };

    Movie.prototype.update = function(m, c) {
      var attachName, c1, depth, lwfContainer, m1, movie, obj, objHasOwnColorTransform, objHasOwnMatrix, objc, objm, v, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4;
      if (!this.active) {
        return;
      }
      if (!this.overriding) {
      ...
      if ((this.attachedMovies != null) || (this.attachedLWFs != null)) {
        ...
        if (this.attachedLWFs != null) {
          ...
          this.detachedLWFs = {};
          _ref4 = this.attachedLWFList;
          for (_k = 0, _len1 = _ref4.length; _k < _len1; _k++) {
            lwfContainer = _ref4[_k];
            if (lwfContainer != null) {
    ...
    Movie.prototype.render = function(v, rOffset) {
      var attachedMovie, child, depth, lwfContainer, obj, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3;
      if (!this.visible || !this.active) {
        v = false;
      }
      if (((_ref = this.handler) != null ? _ref.render : void 0) != null) {
        this.handler.render.call(this);
      }
    ...
    Movie.prototype.destroy = function() {
      var k, lwfContainer, movie, obj, _i, _len, _ref, _ref1, _ref2, _ref3;
      _ref = this.displayList;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        obj = _ref[_i];
        if (obj != null) {
      ...
      if (((_ref3 = this.handler) != null ? _ref3.unload : void 0) != null) {
        this.handler.unload.call(this);
      }
      this.instanceHead = null;
      this.instanceTail = null;
      this.displayList = null;
  ...
  MovieEventHandlers = (function() {

    function MovieEventHandlers(load, postLoad, unload, enterFrame, update, render) {
      this.load = load;
  ...
  ButtonEventHandlers = (function() {

    function ButtonEventHandlers(load, unload, enterFrame, update, render, rollOver, rollOut, press, release, keyPress) {
      this.load = load;
      this.unload = unload;
      this.enterFrame = enterFrame;
      this.update = update;
  ...
  LWF = (function() {
    var EXEC_LIMIT, ROUND_OFF_TICK_RATE;
    ...
    LWF.prototype.setMovieEventHandler = function(instanceName, handlers) {
      var enterFrame, instId, load, postLoad, render, unload, update, _ref;
      load = handlers["load"];
      ...
      if (instId >= 0 && instId < this.data.instanceNames.length) {
        if ((load != null) || (postLoad != null) || (unload != null) || (enterFrame != null) || (update != null) || (render != null)) {
          handlers = new MovieEventHandlers(load, postLoad, unload, enterFrame, update, render);
        } else {
          handlers = null;
        }
        this.movieEventHandlers[instId] = handlers;
        if (instId === this.rootMovie.instanceId) {
          this.rootMovie.handler = handlers;
        }
      }
      if (instanceName.indexOf(".") === -1) {
        return;
      ...
      if ((load != null) || (postLoad != null) || (unload != null) || (enterFrame != null) || (update != null) || (render != null)) {
        this.movieEventHandlersByFullName[instanceName] = new MovieEventHandlers(load, postLoad, unload, enterFrame, update, render);
      } else {
        delete this.movieEventHandlersByFullName[instanceName];
      }
    };
    ...
    LWF.prototype.setButtonEventHandler = function(instanceName, handlers) {
      var enterFrame, instId, keyPress, load, press, release, render, rollOut, rollOver, unload, update, _ref;
      ...
      instId = this.searchInstanceId(this.getStringId(instanceName));
      if (instId >= 0 && instId < this.data.instanceNames.length) {
        if ((load != null) || (unload != null) || (enterFrame != null) || (update != null) || (render != null) || (rollOver != null) || (rollOut != null) || (press != null) || (release != null) || (keyPress != null)) {
          handlers = new ButtonEventHandlers(load, unload, enterFrame, update, render, rollOver, rollOut, press, release, keyPress);
        } else {
          handlers = null;
        }
        this.buttonEventHandlers[instId] = handlers;
      }
      if (instanceName.indexOf(".") === -1) {
        return;
      }
      ...
      if ((load != null) || (unload != null) || (enterFrame != null) || (update != null) || (render != null) || (rollOver != null) || (rollOut != null) || (press != null) || (release != null) || (keyPress != null)) {
        this.buttonEventHandlersByFullName[instanceName] = new ButtonEventHandlers(load, unload, enterFrame, update, render, rollOver, rollOut, press, release, keyPress);
      } else {
        delete this.buttonEventHandlersByFullName[instanceName];
      }
    };
      ...
      while (true) {
        ...
        switch (a) {
          ...
          case Animation.EVENT:
            ...
            if (this.eventHandlers[eventId] != null) {
              this.eventHandlers[eventId](movie, button);
            }
            break;
          case Animation.CALL:
  ...
  WebkitCSSResourceCache = (function() {
    ...
    WebkitCSSResourceCache.prototype.checkTextures = function(settings, data) {
      var m, orig, pm, pngFilename, pngURL, rgb, t, texture, url, _base, _i, _len, _ref1, _ref2, _results;
      settings._alphaMap = {};
      settings._rgbMap = {};
      settings._textures = [];
      _ref1 = data.textures;
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        if (m != null) {
          ...
          _results.push(settings._alphaMap[t.filename] = [texture, t]);
        } else {
    ...
    WebkitCSSResourceCache.prototype.onloaddata = function(settings, data, url) {
      ...
      if (data.useScript) {
        return this.loadJS(settings, data);
      } else {
        return this.loadImages(settings, data);
      }
    };
    ...
    WebkitCSSResourceCache.prototype.loadLWF = function(settings) {
      ...
      return this.loadLWFData(settings, url);
    };
    ...
    WebkitCSSResourceCache.prototype.loadImagesCallback = function(settings, imageCache, data) {
      ...
      if (settings.loadedCount === settings.total) {
        ...
        if (settings.error.length > 0) {
          ...
          return this.newLWF(settings, imageCache, data);
        }
      }
    };

    WebkitCSSResourceCache.prototype.generateImages = function(settings, imageCache, texture, image) {
      var canvas, ctx, d, i, imageData, n, name, o, pixels, _i, _len, _results;
      ...
      if (d != null) {
        ...
        for (_i = 0, _len = d.length; _i < _len; _i++) {
          ...
          if (this.constructor === WebkitCSSResourceCache) {
            ...
            ctx = document.getCSSCanvasContext("2d", name, image.width, image.height);
            canvas = ctx.canvas;
            canvas.name = name;
          } else {
          ...
          _results.push(imageCache[o.filename] = canvas);
        }
        return _results;
      }
    };
    ...
    WebkitCSSResourceCache.prototype.newFactory = function(settings, cache, data) {
      var _ref1;
      return new WebkitCSSRendererFactory(data, this, cache, settings["stage"], (_ref1 = settings["textInSubpixel"]) != null ? _ref1 : false, true);
    };
    ...
    WebkitCSSResourceCache.prototype.setParticleConstructor = function(ctor) {
      return this.particleConstructor = ctor;
    };

    WebkitCSSResourceCache.prototype.setDOMElementConstructor = function(ctor) {
      return this.domElementConstructor = ctor;
    };
  ...
  Cocos2dRendererFactory = (function() {

    function Cocos2dRendererFactory(data, resourceCache, cache, textInSubpixel) {
      var bitmap, bitmapEx, particle, text, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4;
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        bitmapEx.w = 1;
        bitmapEx.h = 1;
        this.bitmapContexts.push(new Cocos2dBitmapContext(this, data, bitmapEx));
      }
      ...
      for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
        ...
        this.bitmapExContexts.push(new Cocos2dBitmapContext(this, data, bitmapEx));
      }
      this.textContexts = [];
      _ref3 = data.texts;
      for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
        text = _ref3[_k];
        this.textContexts.push(new Cocos2dTextContext(this, data, text));
      }
      this.particleContexts = [];
      _ref4 = data.particles;
      for (_l = 0, _len3 = _ref4.length; _l < _len3; _l++) {
        particle = _ref4[_l];
        this.particleContexts.push(new Cocos2dParticleContext(this, data, particle));
      }
      this.lwfNode = null;
    }

    Cocos2dRendererFactory.prototype.destruct = function() {
    ...
    Cocos2dRendererFactory.prototype.init = function(lwf) {
    ...
    Cocos2dRendererFactory.prototype.beginRender = function(lwf) {};

    Cocos2dRendererFactory.prototype.endRender = function(lwf) {};

    Cocos2dRendererFactory.prototype.constructBitmap = function(lwf, objectId, bitmap) {
      var context;
      context = this.bitmapContexts[objectId];
      if (context) {
        return new Cocos2dBitmapRenderer(context);
      }
    };

    Cocos2dRendererFactory.prototype.constructBitmapEx = function(lwf, objectId, bitmapEx) {
      var context;
    ...
    Cocos2dRendererFactory.prototype.constructText = function(lwf, objectId, text) {
      var context;
      context = this.textContexts[objectId];
      if (context) {
        return new Cocos2dTextRenderer(lwf, context, text);
      }
    };

    Cocos2dRendererFactory.prototype.constructParticle = function(lwf, objectId, particle) {
      var context;
      context = this.particleContexts[objectId];
      if (context) {
        return new Cocos2dParticleRenderer(context);
      }
    };
    ...
    Cocos2dRendererFactory.prototype.getSize = function() {
      var h, s, w;
      if (this.lwfNode != null) {
        s = this.lwfNode.getContentSize();
        w = s.width;
        h = s.height;
      }
      if (w === 0 && h === 0) {
        if (typeof cc.Director.getInstance().winSizeInPixels !== "undefined") {
    ...
    Cocos2dRendererFactory.prototype.fitForHeight = function(lwf) {
      var h, w, _ref1;
    ...
    Cocos2dRendererFactory.prototype.fitForWidth = function(lwf) {
      var h, w, _ref1;
      _ref1 = this.getSize(), w = _ref1[0], h = _ref1[1];
    ...
    Cocos2dRendererFactory.prototype.scaleForHeight = function(lwf) {
      var h, w, _ref1;
      _ref1 = this.getSize(), w = _ref1[0], h = _ref1[1];
      if (h !== 0 && h !== lwf.data.header.height) {
    ...
    Cocos2dRendererFactory.prototype.scaleForWidth = function(lwf) {
      var h, w, _ref1;
      _ref1 = this.getSize(), w = _ref1[0], h = _ref1[1];
      if (w !== 0 && w !== lwf.data.header.width) {
    ...
    Cocos2dRendererFactory.prototype.setBackgroundColor = function(lwf) {
      var b, bgColor, g, r;
    ...
    return Cocos2dRendererFactory;

  })();

  Cocos2dBitmapContext = (function() {

    function Cocos2dBitmapContext(factory, data, bitmapEx) {
      var filename, h, imageScale, texture, w;
      this.factory = factory;
      this.data = data;
      this.fragment = data.textureFragments[bitmapEx.textureFragmentId];
      texture = data.textures[this.fragment.textureId];
      filename = this.factory.cache[texture.filename];
      this.texture2d = cc.TextureCache.getInstance().textureForKey(filename);
      if (typeof this.texture2d.getPixelsWide !== "undefined") {
        imageScale = this.texture2d.getPixelsWide() / texture.width;
      } else {
        imageScale = this.texture2d.width / texture.width;
      }
      ...
      this.imageHeight = this.fragment.h * imageScale;
      this.rect = cc.rect(this.fragment.u, this.fragment.v, w, h);
    }

    Cocos2dBitmapContext.prototype.destruct = function() {};

    return Cocos2dBitmapContext;

  })();

  Cocos2dBitmapRenderer = (function() {

    function Cocos2dBitmapRenderer(context) {
      var fragment;
      this.context = context;
      fragment = this.context.fragment;
      this.matrix = new Matrix(0, 0, 0, 0, 0, 0);
      if (fragment.rotated || fragment.x !== 0 || fragment.y !== 0 || this.context.scale !== 1) {
        this.matrixForAtlas = new Matrix();
      }
      this.bitmap = cc.LWFBitmap.lwfBitmapWithTexture(this.context.texture2d, this.context.rect);
      this.visible = true;
      this.alpha = 1;
      this.z = -1;
    }

    Cocos2dBitmapRenderer.prototype.destruct = function() {
      return this.bitmap.removeFromParentAndCleanup(true);
    };

    Cocos2dBitmapRenderer.prototype.render = function(m, c, renderingIndex, renderingCount, visible) {
      var fragment, scale, x, y, z;
      z = renderingIndex;
      if (this.z !== z) {
        if (this.z === -1) {
          this.context.factory.lwfNode.addChild(this.bitmap, z);
        } else {
          this.bitmap.getParent().reorderChild(this.bitmap, z);
        }
        this.z = z;
      }
      if (this.matrix.setWithComparing(m)) {
        ...
        if (fragment.rotated) {
          m = Utility.rotateMatrix(this.matrixForAtlas, m, scale, x, y + fragment.h);
        } else if (scale !== 1 || x !== 0 || y !== 0) {
          m = Utility.scaleMatrix(this.matrixForAtlas, m, scale, x, y);
        }
        this.bitmap.setMatrix(m);
      }
      if (this.alpha !== c.multi.alpha || this.visible !== visible) {
        this.alpha = c.multi.alpha;
        this.visible = visible;
        return this.bitmap.setOpacity(this.visible ? this.alpha * 255 : 0);
      }
    };

    return Cocos2dBitmapRenderer;

  })();

  Align = Format.TextProperty.Align;

  Cocos2dTextContext = (function() {

    function Cocos2dTextContext(factory, data, text) {
      var font;
      this.factory = factory;
      this.data = data;
      this.text = text;
    ...
    Cocos2dTextContext.prototype.destruct = function() {};

    return Cocos2dTextContext;

  })();

  Cocos2dTextRenderer = (function() {

    function Cocos2dTextRenderer(lwf, context, textObject) {
      var align, scale, verticalAlign, _ref1;
      this.lwf = lwf;
      this.context = context;
      ...
      switch (this.context.textProperty.align & Align.VERTICAL_MASK) {
      ...
      this.label = cc.LWFLabel.create("", this.context.fontName, this.context.textProperty.fontHeight * scale, cc.size(this.context.text.width * scale, this.context.text.height * scale), align, verticalAlign);
      this.z = -1;
      this.textRendered = false;
    }

    Cocos2dTextRenderer.prototype.destruct = function() {
      this.label.removeFromParentAndCleanup(true);
    };

    Cocos2dTextRenderer.prototype.render = function(m, c, renderingIndex, renderingCount, visible) {
      var alpha, blue, colorChanged, green, red, str, strChanged, z;
      if (!visible) {
      ...
      if (this.z !== z) {
        if (this.z === -1) {
          this.context.factory.lwfNode.addChild(this.label, z);
        } else {
          this.label.getParent().reorderChild(this.label, z);
        }
        this.z = z;
      }
      red = this.color.red;
      ...
      colorChanged = false;
      if (red !== this.color.red || green !== this.color.green || blue !== this.color.blue || alpha !== this.color.alpha) {
      ...
      if (this.matrix.setWithComparing(m)) {
        ...
        this.label.setMatrix(m);
      }
    };

    Cocos2dTextRenderer.prototype.renderText = function(c) {
      this.textRendered = true;
      this.label.setColor(c);
      this.label.setString(this.str);
    };

    return Cocos2dTextRenderer;

  })();

  Cocos2dParticleContext = (function() {

    function Cocos2dParticleContext(factory, data, particle) {
      var particleData;
      this.factory = factory;
      this.data = data;
      particleData = data.particleDatas[particle.particleDataId];
      this.name = data.strings[particleData.stringId];
      this.plist = this.factory.resourceCache.particlePrefix + this.name + this.factory.resourceCache.particleSuffix;
    }

    Cocos2dParticleContext.prototype.destruct = function() {};

    return Cocos2dParticleContext;

  })();

  Cocos2dParticleRenderer = (function() {

    function Cocos2dParticleRenderer(context) {
      this.context = context;
      this.matrix = new Matrix();
      this.particle = cc.LWFParticle.create(this.context.plist);
      this.visible = true;
      this.alpha = 1;
      this.z = -1;
    }

    Cocos2dParticleRenderer.prototype.destruct = function() {
      return this.particle.removeFromParentAndCleanup(true);
    };

    Cocos2dParticleRenderer.prototype.update = function(m, c) {};

    Cocos2dParticleRenderer.prototype.render = function(m, c, renderingIndex, renderingCount, visible) {
      var z;
      z = renderingIndex;
      if (this.z !== z) {
        if (this.z === -1) {
          this.context.factory.lwfNode.addChild(this.particle, z);
        } else {
          this.particle.getParent().reorderChild(this.particle, z);
        }
        this.z = z;
      }
      if (this.matrix.setWithComparing(m)) {
        this.particle.setMatrix(this.matrix);
      }
      if (this.alpha !== c.multi.alpha || this.visible !== visible) {
        this.alpha = c.multi.alpha;
        this.visible = visible;
        return this.particle.setOpacity(this.visible ? this.alpha * 255 : 0);
      }
    };

    return Cocos2dParticleRenderer;

  })();

  Cocos2dResourceCache = (function(_super) {

    __extends(Cocos2dResourceCache, _super);

    function Cocos2dResourceCache() {
      Cocos2dResourceCache.__super__.constructor.apply(this, arguments);
      this.particlePrefix = "res/";
      this.particleSuffix = ".plist";
    }

    Cocos2dResourceCache.prototype.loadLWFNode = function(settings) {
      settings._loadLWF = true;
      this.loadLWF(settings);
    };

    Cocos2dResourceCache.prototype.loadLWFNodes = function(settingsArray, onloadall) {
      var settings, _i, _len;
      for (_i = 0, _len = settingsArray.length; _i < _len; _i++) {
        settings = settingsArray[_i];
        settings._loadLWF = true;
      }
      this.loadLWFs(settingsArray, onloadall);
    };

    Cocos2dResourceCache.prototype.newFactory = function(settings, cache, data) {
      var _ref1;
      return new Cocos2dRendererFactory(data, this, cache, (_ref1 = settings["textInSubpixel"]) != null ? _ref1 : false);
    };

    Cocos2dResourceCache.prototype.loadLWFData = function(settings, url) {
      var data;
      if (typeof XMLHttpRequest === "undefined") {
        data = cc.loadFileIntoMemory(cc.FileUtils.sharedFileUtils().fullPathFromRelativePath(url));
        data = Loader.loadArrayBuffer(data);
        return this.onloaddata(settings, data, url);
      } else {
        return Cocos2dResourceCache.__super__.loadLWFData.apply(this, arguments);
      }
    };

    Cocos2dResourceCache.prototype.onloadLWF = function(settings, lwf) {
      var factory, lwfNode, s;
      if (settings._loadLWF != null) {
    ...
    Cocos2dResourceCache.prototype.clear = function() {
      var cache, k, name, url, _ref1;
      _ref1 = this.cache;
      for (k in _ref1) {
        cache = _ref1[k];
        for (name in cache) {
      ...
      return Cocos2dResourceCache.__super__.clear.apply(this, arguments);
    };

    Cocos2dResourceCache.prototype.onLoadImage = function() {
      var cache, data, imageCache;
      this.loadedCount++;
      if (this.onprogress != null) {
        this.onprogress.call(this, this.loadedCount, this.total);
      }
      if (this.loadedCount === this.total) {
        ...
        delete this._cache;
        delete this._data;
        delete this._imageCache;
        cache.newLWF(this, imageCache, data);
      }
    };
    ...
    Cocos2dResourceCache.prototype.loadImages = function(settings, data) {
      ...
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        ...
        url = (_ref5 = (_ref6 = settings["imageMap"]) != null ? _ref6[name] : void 0) != null ? _ref5 : name;
        if (!url.match(/^\//)) {
          url = prefix + url;
        }
        url = url.replace(/(\.png|\.jpg)$/i, suffix + "$1");
        ...
        if (typeof tc.addImageAsync !== "undefined") {
          tc.addImageAsync(url, settings, this.onLoadImage);
        } else {
          tc.addImage(url);
          this.onLoadImage.call(settings);
        }
      }
    };
    ...
    Cocos2dResourceCache.prototype.setParticlePath = function(prefix, suffix) {
      this.particlePrefix = prefix;
      this.particleSuffix = suffix;
    };

    return Cocos2dResourceCache;
  ...
  Cocos2dRendererFactory.prototype["convertColor"] = Cocos2dRendererFactory.prototype.convertColor;

  Cocos2dRendererFactory.prototype["fitForHeight"] = Cocos2dRendererFactory.prototype.fitForHeight;

  Cocos2dRendererFactory.prototype["fitForWidth"] = Cocos2dRendererFactory.prototype.fitForWidth;

  Cocos2dRendererFactory.prototype["scaleForHeight"] = Cocos2dRendererFactory.prototype.scaleForWidth;

  Cocos2dRendererFactory.prototype["scaleForStage"] = Cocos2dRendererFactory.prototype.scaleForWidth;

  Cocos2dRendererFactory.prototype["setBackgroundColor"] = Cocos2dRendererFactory.prototype.setBackgroundColor;

  Cocos2dResourceCache.prototype["clear"] = Cocos2dResourceCache.prototype.clear;

  Cocos2dResourceCache.prototype["getCache"] = Cocos2dResourceCache.prototype.getCache;

  Cocos2dResourceCache.prototype["loadLWF"] = Cocos2dResourceCache.prototype.loadLWF;

  Cocos2dResourceCache.prototype["loadLWFs"] = Cocos2dResourceCache.prototype.loadLWFs;

  Cocos2dResourceCache.prototype["unloadLWF"] = Cocos2dResourceCache.prototype.unloadLWF;

  Cocos2dResourceCache.prototype["setParticleConstructor"] = Cocos2dResourceCache.prototype.setParticleConstructor;

  Cocos2dResourceCache.prototype["setDOMElementConstructor"] = Cocos2dResourceCache.prototype.setDOMElementConstructor;

  if (typeof cc !== "undefined" && cc !== null) {
    cc.LWFBitmap = cc.Sprite.extend({
      _m_lwf_matrix: null,
      ctor: function() {
        return cc.associateWithNative(this, cc.Sprite);
      },
      initWithTexture: function(texture, rect) {
        var result;
        result = this._super(texture, rect);
      ...
      setMatrix: function(m) {
        if (typeof this._super !== "undefined") {
          ...
          this._m_lwf_matrix = m;
        }
      },
      transform: function(ctx) {
        var context, m;
        context = ctx != null ? ctx : cc.renderContext;
        m = this._m_lwf_matrix;
        context.transform(m.scaleX, m.skew1, m.skew0, m.scaleY, m.translateX, m.translateY - cc.canvas.height);
      }
    });
    cc.LWFBitmap.lwfBitmapWithTexture = function(texture, rect) {
      var pLWFBitmap;
    ...
    cc.LWFLabel = cc.LabelTTF.extend({
      _m_lwf_matrix: null,
      ctor: function() {
        return cc.associateWithNative(this, cc.LabelTTF);
      },
      initWithString: function() {
        var a, result;
        if (typeof this._super !== "undefined") {
          result = this._super(arguments[0]);
        } else {
          a = arguments[0];
          result = this.initWithStringFontNameFontSize(a[0], a[1], a[2]);
        }
        this.setAnchorPoint(cc.p(0, 1));
        return result;
      },
    ...
    cc.LWFParticle = cc.ParticleSystem.extend({
      _m_lwf_matrix: null,
      ctor: function() {
        return cc.associateWithNative(this, cc.ParticleSystem);
      },
      setMatrix: function(m) {
        if (typeof this._super !== "undefined") {
          this._super({
    ...
    cc.LWFParticle.create = function(plist) {
      var pLWFParticle;
    ...
    cc.LWFNode = cc.Node.extend({
      ...
      ctor: function() {
        return cc.associateWithNative(this, cc.Node);
      },
      initWithLWF: function(lwf) {
        if (typeof this.init !== "undefined") {
          this.init();
        }
        lwf.rendererFactory.lwfNode = this;
        this._m_lwf = lwf;
        this.scheduleUpdate();
        return true;
      },
      ...
      */
      ...
      onEnter: function() {
        var d;
        if (this._m_lwf.interactive) {
          d = cc.Director.getInstance();
          if (typeof d.getTouchDispatcher !== "undefined") {
            d.getTouchDispatcher().addTargetedDelegate(this, 0, true);
            this._m_targetedDelegateAdded = true;
          }
        }
        return this._super();
      },
      onExit: function() {
        if (this._m_targetedDelegateAdded) {
      ...
      onTouchBegan: function(touch, event) {
        ...
        this._m_lwf.inputPress();
        return true;
      },
      onTouchMoved: function(touch, event) {
        var p;
        p = this.convertTouchToNodeSpace(touch);
        p = cc.Director.getInstance().convertToGL(p);
        this._m_lwf.inputPoint(p.x, p.y);
      },
      onTouchEnded: function(touch, event) {
        this.onTouchMoved(touch, event);
        this._m_lwf.inputRelease();
      }
    });
    cc.LWFNode.lwfNodeWithLWF = function(lwf) {
      var pLWFNode;
